...
$_ENV['NomeFormulario'] = 'r61-acidente_viatura';

$ArquivoGravadoX='../Arquivos/r61-acidente_viatura.tmp'.date("dmY")."-".rand(1,1000).".rtf";
$ArquivoPadrao = 'relatorios/r61-acidente_viatura.rel';
...
if ($TxtWhere <> '' or $_GET['TxtOrdenar'] <> '')
{
    ...
    $smsecurequery = "select Viatura.CODIGO_VIATURA as 'VIATURA', Tipo_Acidente.DESCRICAO as 'OCORRENCIA', CONCAT(substring(Acidentes.DATA,9,2),'/',substring(Acidentes.DATA,6,2),'/',substring(Acidentes.DATA,1,4)) AS 'DATA', Acidentes.NR_FICHA as 'FICHA', Acidentes.ODOMETRO as 'ODOMETRO' from Viatura, Tipo_Acidente, Acidentes where Viatura.ID = Acidentes.ID_VIATURA and Tipo_Acidente.ID = Acidentes.ID_TIPO_ACIDENTE " . $TxtWhere . " order by " . VerificaInsercoesMaliciosas($_GET['TxtOrdenar']);
...
{
    echo '<form name=r61-acidente_viatura method=GET action=r61-acidente_viatura.php>';
    ExibeTitulo('R61 - Acidentes das Viaturas');
