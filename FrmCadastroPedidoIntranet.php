...
require('utilities/CabecalhoIntranet.php');
...
function CriaFormulario($_Mascara)
{
    ...
    echo 'Hora do Pedido';
    echo '</b><br>';
	echo "<input type=text name=TxtDATA_PED value='" . date(d) ."/" . date(m) . "/" . date(Y) . "' maxlength=10 size=18>";
    echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
    echo '<select name=TxtID_OM>';
	...
	echo '</select></td>';
    echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
    echo "<input type=text name=TxtH_PED value='" . date(H) .":" . date(i) . ":" . date(s) . "' maxlength=8 size=8>";
    echo '</p>';
    echo '<b>Responsável pelo Pedido</b><br>';
    echo '<input type=text name=TxtRESP_PED value="" maxlength=100 size=100>';
    echo '<p><b>Responsável pela Apresentação</b><br>';
    echo '<input type=text name=TxtRESP_APRES value="" maxlength=100 size=100>';
    echo '<p><b>';
    echo 'Data da Apresentação';
    echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
    echo 'Hora da Apresentação';
    echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
	echo 'Nº do Pedido';
	echo '</b><br>';
    //echo '<p>';
    echo '<input type=text name=TxtDT_APRES_PREV value="" maxlength=10 size=10>';
    echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
    echo '<input type=text name=TxtH_APRES_PREV value="" maxlength=8 size=8>';
    echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
    if($TxtOpcao=="I")
	{
		...
		for ($t = 1; $t <= @mysql_affected_rows(); $t++)
		{
			$row = mysql_fetch_array($smsecurers);
			$n=$row['ID']+1;
			echo '<b>';echo $n;echo'</b>';
		}
	}
	else
	{
		echo '<b>';echo $_GET['Codigo'];echo'</b>';
	}
   echo '</p>';
   echo '<p><b>';
   echo 'Destino';
   echo '</b><br>  ';
   echo'<input type=text name=TxtDESTINO_PED value="" maxlength=100 size=100>';
   echo'<p><b>';
   echo 'Descrição do Serviço';
   echo '</b><br>  ';
   echo '  <input type=text name=TxtDESC_PED value="" maxlength=100 size=100>';
   echo '</table>';
   echo '</form>';
